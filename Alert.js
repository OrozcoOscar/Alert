...
class Alert {
     ...
     *  }]
     */
    static alert(text = { title: "", contenido: "" },
     opction = [{ name: "Aceptar", onclick:()=>{}, type: 1 }]) {
        ...
        let css2 = `
            ...
            align-items: center;
            `
        let cssColors = ["#2ba52b;", "#a83828;", "#696868;", "#39659d;", "#ede814;"]
        ...
        opction.map(op =>{
            ...
            style="padding: .5rem;
            border: none;
            background: ${cssColors[op.type - 1]}
            color: white;
            border-radius: 5px;
            margin: 1rem;
            cursor:pointer;
